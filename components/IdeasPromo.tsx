    ...
    <section className="relative w-full py-24 px-6 bg-cyber-black overflow-hidden border-t border-b border-neon-orange/30">
      ...
      <div className="max-w-[1400px] mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col gap-6">
            <span className="text-primary font-pixel text-xl uppercase tracking-widest mb-2 block">02 // SIH</span>
            {/* Glitchy Label */}
            ...
            <p className="text-gray-400 font-display text-xl max-w-lg leading-relaxed border-l-4 border-white/20 pl-6">
                ...
                Enter <strong>SIH</strong>. Pitch your concept, get vetted by industry leaders, and secure the resources to build it.
            </p>

            {/* Stats Row */}
            <div className="flex gap-8 mt-4 font-pixel text-lg text-gray-500">
                <div>
                    <span className="block text-2xl text-white">60+</span>
                    <span>Teams Competing</span>
                </div>
                <div>
                    <span className="block text-2xl text-white">National</span>
                    <span>Hackathon</span>
                </div>
                <div>
