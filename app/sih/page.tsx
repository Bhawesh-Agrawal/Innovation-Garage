              ...
              {[
                {
                  ...
                  points: [
                    "2 to 6 members per team (including leader)",
                    "At least one female member is mandatory",
                    "All members must be full-time NITW students",
                    "Inter-institute teams are NOT allowed",
                  ],
                },
                {
                  icon: "engineering",
                  ...
                  points: [
                    "Hardware: Multidisciplinary teams encouraged (mech, electronics, design, programming)",
                    "Software: Primarily strong programmers",
                    "Hardware teams must submit a Bill of Materials (BOM) PDF",
                    "Both tracks welcome — choose based on your PS",
                  ],
                },
                {
                  icon: "lightbulb",
                  ...
                  points: [
                    "Choose from official SIH PSs at sih.gov.in",
                    "Select PSs aligned with your team's skills",
                    "You may choose up to 2 problem statements",
                    "PS IDs are required during registration",
                  ],
                },
                {
                  icon: "verified",
                  ...
                  points: [
                    "Regular full-time NITW students only",
                    "Team leader is the primary point of contact",
                    "Consent to documentation is mandatory",
