...
const teamData = {
  "SF & Outreach": [
    {
      ...
      img: "/teams/Lavanya.png",
      link: "https://www.linkedin.com/in/lavanyatrivedi/?originalSubdomain=in"
    },
    {
      name: "K Jnana Vaishnavi",
      role: "Addl. Sec",
      dept: "CHEM Dept. - 4th Year",
  ...
  Operations: [
    ...
    },
    {
      ...
      img: "/teams/Aryan jain.png",
      link: "https://www.linkedin.com/in/aryan-jain-67484b309?utm_source=share_via&utm_content=profile&utm_medium=member_android"
    },
    {
      name: "Sanjana",
      role: "Executive",
      dept: "ECE Dept. - 2nd Year",
      img: "/teams/Sanjana.png",
      link: "https://www.linkedin.com/in/segu-bhavyasai-sanjana-9698a53ab?utm_source=share_via&utm_content=profile&utm_medium=member_android"
    },
    {
      name: "Aryan",
      role: "Executive",
  ...
  Creative: [
    ...
    },
    {
      ...
      role: "Executive",
      dept: "BT Dept. - 3rd Year",
      img: "/teams/Ragacharan.png",
      link: "https://www.linkedin.com/in/sriragacharan-vemuri-9b752b326"
    },
    {
      name: "Ashutosh T",
      role: "Executive",
      dept: "Mathematics Dept. - 2nd Year",
      img: "/teams/Ashutosh T.png",
      link: "https://www.linkedin.com/in/1shu1iwari?utm_source=share_via&utm_content=profile&utm_medium=member_android"
    },
    {
      name: "Kushagra",
      role: "Executive",
      dept: "MME Dept. - 2nd Year",
      img: "/teams/Kushagra.png",
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-12">
              {Object.keys(teamData).map((tab) => (
                <button
                  key={tab}
                  onClick={() => setActiveTab(tab as any)}
                  className={`cursor-pointer px-8 py-3 border-2 text-xl uppercase tracking-widest transition-all duration-200 select-none font-pixel ${activeTab === tab
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 animate-fade-in">
                {teamData[activeTab].map((member, idx) => (
                  <div key={idx} className="bg-surface-card border-2 border-white/5 p-4 flex flex-col items-center text-center hover:border-white/20 transition-all group relative">
                    ...
                    <a className={`w-full py-2 border border-white/20 text-cyber-lavender hover:text-white transition-all uppercase flex justify-center items-center gap-2 font-pixel ${member.role === 'Addl. Sec'
